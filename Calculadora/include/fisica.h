...
const long double CONST_ELEC = 9000000000;
...
long double LGU(long double fuerza, long double masa1, long double masa2, long double distancia, int seleccion) {
    switch (seleccion) {
        case 0:
...
long double CalorEspecifico(long double calor, long double masa, long double CalorEsp,
                            long double TempInicial, long double TempFinal, int seleccion){
    long double delta;
    delta = TempFinal - TempInicial;
    switch(seleccion){
        case 0:
            calor = masa * CalorEsp * delta;
            return calor;
        case 1:
            masa = calor / (CalorEsp * (TempFinal - TempInicial));
            return masa;
        case 2:
            CalorEsp = calor / (masa * (TempFinal - TempInicial));
            return CalorEsp;
        case 3:
            TempInicial = TempFinal - (calor / (masa * CalorEsp));
            return TempInicial;
        case 4:
            TempFinal = calor / (masa * CalorEsp) + TempInicial;
            return TempFinal;
        default:
            return -1048576;
            break;
...
long double Coloumb(long double fuerza, long double carga1, long double carga2, long double distancia, int seleccion) {
    switch (seleccion) {
        case 0:
            return (CONST_ELEC * carga1 * carga2) / (distancia * distancia);
            break;
        case 1:
            return (fuerza * pow(distancia, 2)) / (carga1 * CONST_ELEC);
            break;
        case 2:
            return sqrt((CONST_ELEC * carga1 * carga2) / fuerza);
            break;
        default:
            return -1048576;
    }
