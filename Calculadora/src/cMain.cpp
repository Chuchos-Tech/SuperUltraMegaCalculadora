...
wxTreeItemId CalEspCal;
wxTreeItemId CalEspMas;
wxTreeItemId CalEspCalEsp;
wxTreeItemId CalEspTempIni;
wxTreeItemId CalEspTempFin;
...
cMain::cMain() : wxFrame(nullptr, wxID_ANY, "Calculadora", wxPoint(10, 10), wxSize(615, 555), wxDEFAULT_FRAME_STYLE & ~(wxRESIZE_BORDER | wxMAXIMIZE_BOX)){
    ...
    wxTreeItemId rootId = m_tree1 -> AddRoot("Calculos");
        ...
        wxTreeItemId CalEspID = m_tree1 -> AppendItem(rootId, "Calor Especifico");
          CalEspCal = m_tree1 -> AppendItem(CalEspID, "Calor");
          CalEspMas = m_tree1 -> AppendItem(CalEspID, "Masa");
          CalEspCalEsp = m_tree1 -> AppendItem(CalEspID, "Calor Especifico");
          CalEspTempIni = m_tree1 -> AppendItem(CalEspID, "Temperatura Inicial");
          CalEspTempFin = m_tree1 -> AppendItem(CalEspID, "Temperatura Final");
        wxTreeItemId ColoumbID = m_tree1 -> AppendItem(rootId, "Coloumb");
          ColFue = m_tree1 -> AppendItem(ColoumbID, "Fuerza");
          ColCar = m_tree1 -> AppendItem(ColoumbID, "Carga");
          ColDis = m_tree1 -> AppendItem(ColoumbID, "Distancia");
      ...
      if(nArgumentos != 0){
        ...
        if(Argumentos_current == nArgumentos){ //todos los argumentos han sido recibidos
          ...
          */
          ...
          else if(IDoperacion == ColFue){
            notacion_usado = true;
            m_txt1 -> SetValue(Notacion(Coloumb(INDEF, Argumentos[0], Argumentos[1], Argumentos[2], 0), INDEF, INDEF, INDEF, 6, 1));
          }
          else if(IDoperacion == ColCar){
            notacion_usado = true;
            m_txt1 -> SetValue(Notacion(Coloumb(Argumentos[0], Argumentos[2], INDEF, Argumentos[1], 0), INDEF, INDEF, INDEF, 6, 1));
          }
          else if(IDoperacion == ColDis){
            notacion_usado = true;
            m_txt1 -> SetValue(Notacion(Coloumb(Argumentos[2], Argumentos[0], Argumentos[1], INDEF, 0), INDEF, INDEF, INDEF, 6, 1));
          }
          /*
           * 4 Argumentos
           */
          ...
          else if(IDoperacion == CalEspCal)
            resultado = CalorEspecifico(INDEF, Argumentos[0], Argumentos[1], Argumentos[3], Argumentos[2], 0);
          else if(IDoperacion == CalEspMas)
            resultado = CalorEspecifico(Argumentos[0], INDEF, Argumentos[1], Argumentos[3], Argumentos[2], 1);
          else if(IDoperacion == CalEspCalEsp)
            resultado = CalorEspecifico(Argumentos[0], Argumentos[1], INDEF, Argumentos[3], Argumentos[2], 2);
          else if(IDoperacion == CalEspTempIni)
            resultado = CalorEspecifico(Argumentos[1], Argumentos[2], Argumentos[3], INDEF, Argumentos[0], 3);
          else if(IDoperacion == CalEspTempFin)
            resultado = CalorEspecifico(Argumentos[0], Argumentos[1], Argumentos[2], Argumentos[3], INDEF, 4);
          /*
           *Fin
           */
        if(resultado < 0.000001 && resultado > -0.000001)
          resultado = 0;
        ...
        m_txt2 -> SetValue("La respuesta es:");
           ...
           */
            ...
            if(Argumentos_current == 1)
              m_txt2 -> SetValue("Introduce la segunda carga");
            else
              m_txt2 -> SetValue("Introduce la distancia");
          }
          else if(IDoperacion == ColCar){
            if(Argumentos_current == 1)
              ...
              m_txt2 -> SetValue("Introduce la carga conocida");
          }
          else if(IDoperacion == ColDis){
            if(Argumentos_current == 1)
              m_txt2 -> SetValue("Introduce la segunda carga");
           ...
           */
            ...
            if(Argumentos_current == 1)
              m_txt2 -> SetValue("Introduce el calor especifico");
            else if(Argumentos_current == 2)
              m_txt2 -> SetValue("Introduce la temperatura final");
            else 
              m_txt2 -> SetValue("Introduce la temperatura inicial");
          }
          else if(IDoperacion == CalEspMas){
            if(Argumentos_current == 1)
              m_txt2 -> SetValue("Introduce el calor especifico");
            ...
            if(Argumentos_current == 1)
              ...
              m_txt2 -> SetValue("Introduce temperatura inicial");
          }
          else if(IDoperacion == CalEspTempIni){
            if(Argumentos_current == 1)
              m_txt2 -> SetValue("Introduce el calor");
            else if(Argumentos_current == 2)
              m_txt2 -> SetValue("Introduce la masa");
            else
              m_txt2 -> SetValue("Introduce el calor especifico");
...
void cMain::onTreeSelectionChanged(wxTreeEvent& evt){
  ...
  if(
    ...
    if(IDoperacion == LGUFr)
      ...
      m_txt2 -> SetValue("Introuce la fuerza mayor");
    else if(IDoperacion == ColFue)
      m_txt2 -> SetValue("Introduce la primera carga");
    else if(IDoperacion == ColCar)
      m_txt2 -> SetValue("Introduce la fuerza");
    else if(IDoperacion == ColDis)
      m_txt2 -> SetValue("Introduce la primera carga");
  ...
  if(
    ...
    IDoperacion == CalEspCal ||
    IDoperacion == CalEspMas ||
    IDoperacion == CalEspCalEsp ||
    IDoperacion == CalEspTempIni ||
    IDoperacion == CalEspTempFin
  ) {
    nArgumentos = 4;
    Argumentos_current = 0;
    if(IDoperacion == NotSum || IDoperacion == NotRes ||
      ...
      m_txt2 -> SetValue("Introiduce la temperatura final");
    else if(IDoperacion == CalEspTempFin)
      m_txt2 -> SetValue("Introduce el calor");
  }
}
