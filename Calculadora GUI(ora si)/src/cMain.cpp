...
cMain::cMain() : wxFrame(nullptr, wxID_ANY, "Calculadora", wxPoint(10, 10), wxSize(625, 575)){
    ...
    wxTreeItemId rootId = m_tree1 -> AddRoot("Calculos");
        ...
        wxTreeItemId NotacionID = m_tree1 -> AppendItem(rootId, "Notacion cientifica");
            m_tree1 -> AppendItem(NotacionID, "Suma");
            m_tree1 -> AppendItem(NotacionID, "Resta");
        ...
        m_tree1 -> AppendItem(rootId, "Ondas");
        ...
        wxTreeItemId TrabajoID = m_tree1 -> AppendItem(rootId, "Trabajo");
                m_tree1 -> AppendItem(TrabajoID, "Trabajo");
                m_tree1 -> AppendItem(TrabajoID, "Fuerza");
                m_tree1 -> AppendItem(TrabajoID, "Distancia");
        wxTreeItemId PotenciaID = m_tree1 -> AppendItem(rootId, "Potencia");
                m_tree1 -> AppendItem(PotenciaID, "Potencia");
                m_tree1 -> AppendItem(PotenciaID, "Trabajo");
                m_tree1 -> AppendItem(PotenciaID, "Tiempo");
        wxTreeItemId PresionID = m_tree1 -> AppendItem(rootId, "Presion");
            wxTreeItemId PresionCID = m_tree1 -> AppendItem(PresionID, "Presion");
                m_tree1 -> AppendItem(PresionCID, "Presion");
                m_tree1 -> AppendItem(PresionCID, "Fuerza");
                m_tree1 -> AppendItem(PresionCID, "Area");
            wxTreeItemId PresionHID = m_tree1 -> AppendItem(PresionID, "Presion Hidroestatica");
                m_tree1 -> AppendItem(PresionHID, "Presion");
                m_tree1 -> AppendItem(PresionHID, "Densidad");
                m_tree1 -> AppendItem(PresionHID, "Altura");
            wxTreeItemId PresionAbsID = m_tree1 -> AppendItem(PresionID, "Presion Absoluta");
                m_tree1 -> AppendItem(PresionAbsID, "Presion Absoluta");
                m_tree1 -> AppendItem(PresionAbsID, "Presion Hidroestatica");
                m_tree1 -> AppendItem(PresionAbsID, "Presion Atmosferica");
