...
cMain::cMain() : wxFrame(nullptr, wxID_ANY, "Calculadora", wxPoint(10, 10), wxSize(615, 555), wxDEFAULT_FRAME_STYLE & ~(wxRESIZE_BORDER | wxMAXIMIZE_BOX)){
    //SetBackgroundColour(wxColour(42, 33, 57));
    ...
    m_btn4_4 -> Disable();
    //
    /*m_txt1 -> SetBackgroundColour(wxColour(88, 34, 88));
    m_txt2 -> SetBackgroundColour(wxColour(88, 34, 88));
    m_tree1 -> SetBackgroundColour(wxColour(88, 34, 88));

    m_btn1_1 -> SetBackgroundColour(wxColour(88, 34, 88));
    m_btn1_2 -> SetBackgroundColour(wxColour(88, 34, 88));
    m_btn1_3 -> SetBackgroundColour(wxColour(88, 34, 88));

    m_btn2_1 -> SetBackgroundColour(wxColour(88, 34, 88));
    m_btn2_2 -> SetBackgroundColour(wxColour(88, 34, 88));
    m_btn2_3 -> SetBackgroundColour(wxColour(88, 34, 88));

    m_btn3_1 -> SetBackgroundColour(wxColour(88, 34, 88));
    m_btn3_2 -> SetBackgroundColour(wxColour(88, 34, 88));
    m_btn3_3 -> SetBackgroundColour(wxColour(88, 34, 88));

    m_btn4_1 -> SetBackgroundColour(wxColour(88, 34, 88));
    m_btn4_2 -> SetBackgroundColour(wxColour(88, 34, 88));
    m_btn4_3 -> SetBackgroundColour(wxColour(88, 34, 88));
    m_btn4_4 -> SetBackgroundColour(wxColour(88, 34, 88));
    m_btn4_5 -> SetBackgroundColour(wxColour(88, 34, 88));

    m_btn1_1 -> SetForegroundColour(wxColour(146, 190, 195));
    m_btn1_2 -> SetForegroundColour(wxColour(146, 190, 195));
    m_btn1_3 -> SetForegroundColour(wxColour(146, 190, 195));

    m_btn2_1 -> SetForegroundColour(wxColour(146, 190, 195));
    m_btn2_2 -> SetForegroundColour(wxColour(146, 190, 195));
    m_btn2_3 -> SetForegroundColour(wxColour(146, 190, 195));

    m_btn3_1 -> SetForegroundColour(wxColour(146, 190, 195));
    m_btn3_2 -> SetForegroundColour(wxColour(146, 190, 195));
    m_btn3_3 -> SetForegroundColour(wxColour(146, 190, 195));

    m_btn4_1 -> SetForegroundColour(wxColour(146, 190, 195));
    m_btn4_2 -> SetForegroundColour(wxColour(146, 190, 195));
    m_btn4_3 -> SetForegroundColour(wxColour(146, 190, 195));
    m_btn4_4 -> SetForegroundColour(wxColour(146, 190, 195));
    m_btn4_5 -> SetForegroundColour(wxColour(146, 190, 195));

    m_txt1 -> SetForegroundColour(wxColour(146, 190, 195));
    m_txt2 -> SetForegroundColour(wxColour(177, 34, 157));
    m_tree1 -> SetForegroundColour(wxColour(177, 34, 157));*/
}
        ...
        if(Argumentos_current == nArgumentos){ //todos los argumentos han sido recibidos
          ...
          */
           ...
           */
            ...
            resultado = Energia(Argumentos[1], INDEF, INDEF, Argumentos[1], INDEF, INDEF, 0, 2);
  ...
  if(
    ...
    IDoperacion == ArqPesRe
      ...
      if(IDoperacion == NotRC || IDoperacion == NotConND)
        ...
        m_txt2 -> SetValue("Introduce la velocidad");
      else if(IDoperacion == FuerFue || IDoperacion == EnePotPot)
        m_txt2 -> SetValue("Introduce la masa");
      else if(IDoperacion == FuerMasa || IDoperacion == FuerAce || IDoperacion == EneCinCin ||
